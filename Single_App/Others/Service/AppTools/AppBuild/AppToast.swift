...
//
// @class AppToast.swift
// @abstract Toast工具
// @discussion 实现基本的Toast弹窗显示
//
//░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
// **************************************************************
...
//  MARK: AppToast
public class AppToast: NSObject {
    public static let shared = AppToast()

    private var toastContents: Array<[CanBeToast]> = []
    private var active = false
    private var toastView: AppToastView?
    ...
    override private init() {
        ...
        NotificationCenter.default
            .addObserver(self,
                         selector: #selector(AppToast.keyboardWillAppear(notification:)),
                         name: UIResponder.keyboardWillShowNotification,
                         object: nil)

        NotificationCenter.default
            .addObserver(self,
                         selector: #selector(AppToast.keyboardWillDisappear(notification:)),
                         name: UIResponder.keyboardDidHideNotification,
                         object: nil)

        NotificationCenter.default
            .addObserver(self,
                         selector: #selector(AppToast.orientationWillChange(notification:)),
    ...
    private func showToast() {
        ...
        UIView.setAnimationDidStop(#selector(AppToast.animationStep2))
        toastView?.transform = CGAffineTransform(rotationAngle: degress * .pi / 180.0)
    ...
    @objc private func animationStep2() {
        ...
        UIView.setAnimationDelegate(self)
        UIView.setAnimationDidStop(#selector(AppToast.animationStep3))
...
//  MARK: - AppToastView
fileprivate class AppToastView: UIView {
