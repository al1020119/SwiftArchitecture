...
//
// @class SQLiteModel.swift
// @abstract 数据库模型
// @discussion 实现基本的数据库模型定义
//
//░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
// **************************************************************
...
@objcMembers open class SQLiteModel:NSObject,SQLiteProtocol{
    ...
    class var db:Connection!{
        get{
            if let name = dbName {
                ...
                return SQLiteConfig.getDefaultDB()
            }
...
//    internal func findAll<T:DBModel>(_ predicate: SQLite.Expression<Bool?>) -> [T] where T : SQLiteModel{
//
//        var results:[T] = [T]()
//
//        var query = getTable().where(predicate)
